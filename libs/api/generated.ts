...
export type GetAccountsQuery = { __typename?: 'query_root', balances?: { __typename?: 'balances_balances_query', account: Array<{ __typename?: 'balances_account', id: string, free: any, total: any, updated_at?: number | null }>, account_aggregate: { __typename?: 'balances_account_aggregate', aggregate?: { __typename?: 'balances_account_aggregate_fields', count: number } | null } } | null };
...
export type GetExtrinsicsByIdsQueryVariables = Exact<{
  limit: Scalars['Int'];
  offset?: InputMaybe<Scalars['Int']>;
  idArray?: InputMaybe<Array<Scalars['String']> | Scalars['String']>;
}>;
...
export const GetExtrinsicsByIdsDocument = `
  ...
  archive {
    ...
    `;
export const useGetExtrinsicsByIdsQuery = <
      TData = GetExtrinsicsByIdsQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables: GetExtrinsicsByIdsQueryVariables,
      options?: UseQueryOptions<GetExtrinsicsByIdsQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<GetExtrinsicsByIdsQuery, TError, TData>(
      ['GetExtrinsicsByIds', variables],
      fetcher<GetExtrinsicsByIdsQuery, GetExtrinsicsByIdsQueryVariables>(client, GetExtrinsicsByIdsDocument, variables, headers),
      options
    );
